...
export default function Contact() {
  ...
  const onSubmit = async (data: ContactForm) => {
    ...
    try {
      ...
      const emailUrl = `mailto:marvelman3333@gmail.com?subject=${subject}&body=${body}`;
      ...
      toast({
        ...
        description: "Please contact me directly at marvelman3333@gmail.com",
        variant: "destructive",
      });
    } finally {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "marvelman3333@gmail.com",
      action: () => window.open("mailto:marvelman3333@gmail.com", '_blank')
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+1 480 749 0724",
      action: () => window.open("tel:+14807490724", '_blank')
    },
    {
      icon: MapPin,
      label: "Location",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Ready to build something amazing? Let's discuss your next mobile project and turn your vision into a scalable, high-performance mobile solution.
          </p>
        </motion.div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="pt-6 border-t">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    Looking for a skilled mobile developer to bring your vision to life? 
                    I specialize in Android and iOS development, creating high-performance mobile apps 
                    with intuitive user experiences and robust backend integration.
                  </p>
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <div>📱 Mobile development expertise</div>
