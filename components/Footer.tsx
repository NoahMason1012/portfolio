      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm mb-4">
                Full Stack Mobile Developer specializing in Android and iOS development. 
                Building scalable, high-performance mobile applications with intuitive user experiences.
              </p>
        ...
        >
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <span>© {currentYear} Noah Mason. Made with</span>
