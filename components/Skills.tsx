  ...
  const skillCategories: SkillCategory[] = [
    {
      ...
      icon: Code2,
      skills: [
        { name: "Java", level: 95, category: "mobile" },
        { name: "Kotlin", level: 93, category: "mobile" },
        { name: "Swift", level: 88, category: "mobile" },
        { name: "Objective-C", level: 82, category: "mobile" },
        { name: "React Native", level: 90, category: "mobile" },
        { name: "Flutter", level: 88, category: "mobile" },
        { name: "Android SDK", level: 95, category: "mobile" },
        { name: "iOS Development", level: 88, category: "mobile" },
      ],
    },
    {
      id: "backend",
      ...
      skills: [
        ...
        { name: "JWT Auth", level: 88, category: "backend" },
      ],
    },
    {
      id: "database",
      ...
      skills: [
        ...
        { name: "SQLite", level: 93, category: "database" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Google Cloud", level: 85, category: "cloud" },
        { name: "Git", level: 93, category: "cloud" },
        { name: "CI/CD", level: 88, category: "cloud" },
        { name: "Agile/Scrum", level: 90, category: "cloud" },
      ],
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Technical expertise in mobile development, backend APIs, and cloud integration for building 
